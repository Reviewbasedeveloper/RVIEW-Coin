...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop ReviewBase Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "ReviewBase Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ReviewBase_Coin features */
        {"reviewbase_coin", "listmasternodes", &listmasternodes, true, true, false},
        {"reviewbase_coin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"reviewbase_coin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"reviewbase_coin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"reviewbase_coin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"reviewbase_coin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"reviewbase_coin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"reviewbase_coin", "masternodedebug", &masternodedebug, true, true, false},
        {"reviewbase_coin", "startmasternode", &startmasternode, true, true, false},
        {"reviewbase_coin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"reviewbase_coin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"reviewbase_coin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"reviewbase_coin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"reviewbase_coin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"reviewbase_coin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"reviewbase_coin", "preparebudget", &preparebudget, true, true, false},
        {"reviewbase_coin", "submitbudget", &submitbudget, true, true, false},
        {"reviewbase_coin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"reviewbase_coin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"reviewbase_coin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"reviewbase_coin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"reviewbase_coin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"reviewbase_coin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"reviewbase_coin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"reviewbase_coin", "checkbudgets", &checkbudgets, true, true, false},
        {"reviewbase_coin", "mnsync", &mnsync, true, true, false},
        {"reviewbase_coin", "spork", &spork, true, true, false},
        {"reviewbase_coin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> reviewbase_coin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11914/\n";
}
