 ...
 * ReviewBase_Coin system. There are three: the main network on which people trade goods
...
public:
    ...
    int Reviewbase_CoinBadBlockTime() const { return nReviewbase_CoinBadBlockTime; }
    int Reviewbase_CoinBadBlocknBits() const { return nReviewbase_CoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nReviewbase_CoinBadBlockTime;
    unsigned int nReviewbase_CoinBadBlocknBits;
