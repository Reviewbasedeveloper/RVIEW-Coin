...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ReviewBase Coin"),
     ...
     * override -datadir in the reviewbase_coin.conf file in the default data directory
     * (to be consistent with reviewbase_coind behavior)
     */
