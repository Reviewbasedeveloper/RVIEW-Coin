...
#include "qt/reviewbase_coin/furabstractlistitemdelegate.h"
#include "qt/reviewbase_coin/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/reviewbase_coin/txviewholder.h"
...
#include "config/reviewbase_coin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qreal maxValue = 0;
    qint64 totalRview = 0;
    qint64 totalZrview = 0;
    QList<qreal> valuesRview;
    QList<qreal> valueszRview;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(ReviewBase_CoinGUI* _window);
    ~DashboardWidget();
