...
#include "qt/reviewbase_coin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/reviewbase_coin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(ReviewBase_CoinGUI* _window, QWidget *parent) :
