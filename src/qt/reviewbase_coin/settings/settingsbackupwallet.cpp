...
#include "qt/reviewbase_coin/settings/forms/ui_settingsbackupwallet.h"
#include <QFile>
...
#include "qt/reviewbase_coin/qtutils.h"
SettingsBackupWallet::SettingsBackupWallet(ReviewBase_CoinGUI* _window, QWidget *parent) :
