...
#include "qt/reviewbase_coin/settings/forms/ui_settingsconsolewidget.h"
...
SettingsConsoleWidget::SettingsConsoleWidget(ReviewBase_CoinGUI* _window, QWidget *parent) :
