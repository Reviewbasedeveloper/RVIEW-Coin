...
#include "qt/reviewbase_coin/settings/settingsnetworkwidget.h"
#include "qt/reviewbase_coin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/reviewbase_coin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ReviewBase_CoinGUI* _window, QWidget *parent) :
