...
#include "qt/reviewbase_coin/settings/forms/ui_settingsinformationwidget.h"
...
SettingsInformationWidget::SettingsInformationWidget(ReviewBase_CoinGUI* _window,QWidget *parent) :
