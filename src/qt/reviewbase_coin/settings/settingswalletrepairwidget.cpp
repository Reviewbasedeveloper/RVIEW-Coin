...
#include "qt/reviewbase_coin/settings/forms/ui_settingswalletrepairwidget.h"
...
SettingsWalletRepairWidget::SettingsWalletRepairWidget(ReviewBase_CoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to ReviewBase_CoinGUI::handleRestart()
