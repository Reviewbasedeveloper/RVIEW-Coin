...
#include "qt/reviewbase_coin/requestdialog.h"
#include "qt/reviewbase_coin/forms/ui_requestdialog.h"
#include <QListView>
    ...
    ui(new Ui::RequestDialog)
{
    ...
    ui->labelMessage->setText(tr("Instead of share a ReviewBase Coin address, you can create a Payment Request message which bundles up more information than is contained in just a ReviewBase Coin address."));
    ...
    ui->comboBoxCoin->addItem("RVIEW", 0);
    ...
    ui->lineEditAmount->setPlaceholderText("0.00 RVIEW");
...
void RequestDialog::onNextClicked(){
    if(walletModel) {
        ...
        ui->labelTitle->setText("Request for " + BitcoinUnits::format(displayUnit, value, false, BitcoinUnits::separatorAlways) + " RVIEW");
