...
#include "qt/reviewbase_coin/forms/ui_receivewidget.h"
...
#include "qt/reviewbase_coin/furlistrow.h"
...
ReceiveWidget::ReceiveWidget(ReviewBase_CoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive RVIEW."));
