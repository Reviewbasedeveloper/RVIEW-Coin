...
#include "qt/reviewbase_coin/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 11915");
...
bool MasterNodeWizardDialog::createMN(){
    if (walletModel) {
        ...
        SendCoinsRecipient sendCoinsRecipient(QString::fromStdString(address.ToString()), "", CAmount(2000) * COIN, "");
