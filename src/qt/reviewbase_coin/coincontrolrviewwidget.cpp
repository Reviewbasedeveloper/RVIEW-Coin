...
#include "qt/reviewbase_coin/coincontrolrviewwidget.h"
#include "qt/reviewbase_coin/forms/ui_coincontrolrviewwidget.h"

CoinControlRviewWidget::CoinControlRviewWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlRviewWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select RVIEW Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("RVIEW");
    ...
    ui->labelValueAfter->setText("0.00 RVIEW");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 RVIEW");
    ui->labelValueFee->setText("0.00 RVIEW");
...
CoinControlRviewWidget::~CoinControlRviewWidget()
{
    delete ui;
}
