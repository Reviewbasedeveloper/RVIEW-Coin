...
/** Interface from Qt to configuration data structure for ReviewBase_Coin client.
...
public:
    ...
    enum OptionID {
        ...
        HideOrphans,    // bool
        AnonymizeReviewbase_CoinAmount, //int
...
signals:
    ...
    void anonymizeReviewbase_CoinAmountChanged(int);
