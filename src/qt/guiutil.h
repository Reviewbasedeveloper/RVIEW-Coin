...
/** Utility functions used by the ReviewBase_Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render ReviewBase_Coin addresses in monospace font
...
// Parse "reviewbase_coin:" URI into recipient object, return true on successful parsing
