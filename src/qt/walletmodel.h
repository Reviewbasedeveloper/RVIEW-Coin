...
#ifndef ReviewBase_Coin_QT_WALLETMODEL_H
#define ReviewBase_Coin_QT_WALLETMODEL_H
...
/** Interface to ReviewBase_Coin wallet from Qt view code. */
...
#endif // ReviewBase_Coin_QT_WALLETMODEL_H
