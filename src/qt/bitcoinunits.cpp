...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(RVIEW);
    unitlist.append(mRVIEW);
    unitlist.append(uRVIEW);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case RVIEW:
        return QString("reviewbase_coin");
    case mRVIEW:
        return QString("mreviewbase_coin");
    case uRVIEW:
        return QString::fromUtf8("ureviewbase_coin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case RVIEW:
            return QString("RVIEW");
        case mRVIEW:
            return QString("mRVIEW");
        case uRVIEW:
            return QString::fromUtf8("μRVIEW");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case RVIEW:
            return QString("tRVIEW");
        case mRVIEW:
            return QString("mtRVIEW");
        case uRVIEW:
            return QString::fromUtf8("μtRVIEW");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case RVIEW:
            return QString("RVIEW");
        case mRVIEW:
            return QString("Milli-RVIEW (1 / 1" THIN_SP_UTF8 "000)");
        case uRVIEW:
            return QString("Micro-RVIEW (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case RVIEW:
            return QString("TestRVIEWs");
        case mRVIEW:
            return QString("Milli-TestRVIEW (1 / 1" THIN_SP_UTF8 "000)");
        case uRVIEW:
            return QString("Micro-TestRVIEW (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
