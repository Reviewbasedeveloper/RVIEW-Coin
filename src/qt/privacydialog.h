...
public:
    ...
    void setZRviewControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzRVIEW_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzRVIEW_clicked();
    void on_pushButtonZRviewControl_clicked();
