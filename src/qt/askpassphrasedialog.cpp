...
#include "qt/reviewbase_coin/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR RVIEW</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                ReviewBase_CoinGUI* window = static_cast<ReviewBase_CoinGUI*>(parentWidget());
...
bool AskPassphraseDialog::openStandardDialog(QString title, QString body, QString okBtn, QString cancelBtn){
    ReviewBase_CoinGUI* gui = static_cast<ReviewBase_CoinGUI*>(parentWidget());
...
void AskPassphraseDialog::warningMessage() {
    hide();
    static_cast<ReviewBase_CoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("ReviewBase Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your RVIEWs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
