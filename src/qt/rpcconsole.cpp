                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzRVIEWPathCustom = GetArg("-zrviewbackuppath", "");
    ...
    if(!strzRVIEWPathCustom.empty()) {
        ui->wallet_customzrviewbackuppath->setText(QString::fromStdString(strzRVIEWPathCustom));
        ui->wallet_customzrviewbackuppath_label->setVisible(true);
        ui->wallet_customzrviewbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzRVIEWPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ReviewBase Coin RPC console.") + "<br>" +
