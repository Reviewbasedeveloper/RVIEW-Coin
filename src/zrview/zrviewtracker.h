...
#ifndef ReviewBase_Coin_ZRVIEWTRACKER_H
#define ReviewBase_Coin_ZRVIEWTRACKER_H
...
public:
    CzRVIEWTracker(std::string strWalletFile);
    ~CzRVIEWTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzRVIEWWallet* zRVIEWWallet = NULL);
...
#endif //ReviewBase_Coin_ZRVIEWTRACKER_H
