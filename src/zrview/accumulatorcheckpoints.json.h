...
#ifndef ReviewBase_Coin_ACCUMULATORCHECKPOINTS_JSON_H
#define ReviewBase_Coin_ACCUMULATORCHECKPOINTS_JSON_H
...
#endif //ReviewBase_Coin_ACCUMULATORCHECKPOINTS_JSON_H
