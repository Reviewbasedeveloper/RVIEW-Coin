...
from fake_stake.base_test import ReviewBase_Coin_FakeStakeTest

class zRVIEWwrappedSerialsTest(ReviewBase_Coin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zRVIEWs..." % DENOM_TO_USE)
