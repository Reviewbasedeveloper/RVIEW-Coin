...
This document provides guidelines for internationalization of the ReviewBase_Coin software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to ReviewBase_Coin network</numerusform>
            <numerusform>%n active connections to ReviewBase_Coin network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `reviewbase_coin_en.ts` remains unchanged.
