Contributing to ReviewBase_Coin
============================

The ReviewBase_Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/reviewbase_coin-project/reviewbase_coin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ReviewBase_Coin project, and is not to be
confused with overall ReviewBase_Coin Network Protocol consensus changes.

Whether a pull request is merged into ReviewBase_Coin rests with the project merge
...
Patches that change ReviewBase_Coin consensus rules are considerably more involved than
...
Where a patchset proposes to change the ReviewBase_Coin consensus, it must have been
...
The project leader is the release manager for each ReviewBase_Coin release.
